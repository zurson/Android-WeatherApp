...
public class WindSpeedFragment extends DetailFragment implements WeatherDataUpdater {
    ...
    public void updateData() {
        try {
            ...
            getImageView().setImageResource(R.drawable.wind_speed);
            getImageView().setVisibility(View.VISIBLE);

            getDescriptionTextView().setText("Wind speed");

            getValueTextView().setText(weather.getWindSpeed() + " " + Settings.getSpeedUnit());
